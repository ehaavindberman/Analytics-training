...
export const scenario5: ScenarioProps = {
  ...
  yAxisDefault: "retention_rate_2_months",
  yAxisOptions: ["visitors", "signups", "retention_rate_1_week", "retention_rate_1_month", "retention_rate_2_months", "retained_1_week", "retained_1_month", "retained_2_months"],
  yAxisFormats: {
    "visitors": "number",
    "signups": "number",
    "retention_rate_1_week": "pct",
    "retention_rate_1_month": "pct",
    "retention_rate_2_months": "pct",
